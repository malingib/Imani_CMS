...
const PlatformDashboard: React.FC<PlatformDashboardProps> = ({ stats }) => {
  const cards = [
    { label: 'Total Churches', value: stats.churches, sub: `${stats.subscriptions} active subs`, icon: Building2, color: 'bg-brand-indigo' },
    { label: 'Total Members', value: stats.members, sub: 'across all churches', icon: Users, color: 'bg-brand-primary' },
    { label: 'Total Revenue', value: `KES ${(stats.revenue / 1000).toFixed(0)}K`, sub: 'all time', icon: TrendingUp, color: 'bg-brand-emerald' },
