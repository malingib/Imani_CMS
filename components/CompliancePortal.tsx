    ...
    <div className="max-w-4xl mx-auto py-12 px-6 space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <header className="space-y-4">
        ...
        <p className="text-slate-500 text-lg font-medium leading-relaxed">
          Imani CMS maintains the highest standards of regulatory compliance within the Republic of Kenya, ensuring compliance with Kenyan regulations.
        </p>
      </header>
      ...
      <section className="bg-white p-8 lg:p-12 rounded-[3rem] border border-slate-100 shadow-sm space-y-10">
        <div>
          <h3 className="text-2xl font-black text-slate-800 mb-6 flex items-center gap-3">
             <CheckCircle2 size={24} className="text-brand-emerald"/> Compliance Checklist
          </h3>
        ...
        <div className="p-8 bg-brand-gold/10 border border-brand-gold/20 rounded-[2rem] flex items-start gap-6">
           ...
           <div className="space-y-2">
              <h4 className="font-black text-brand-gold text-sm uppercase tracking-tight">Audit Notice</h4>
      ...
      <footer className="text-center text-[10px] text-slate-300 font-bold py-4">
        Powered by Mobiwave Innovations • Church Management System
      </footer>
    </div>
  );
};
