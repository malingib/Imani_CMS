...
import { 
  ...
  User, UserRole, AppNotification, Toast, ChurchEventType, RecurrenceType
} from './types';
...
const App: React.FC = () => {
  ...
  const [events, setEvents] = useState<ChurchEvent[]>([
    { 
      ...
      description: 'Main service of worship and word.', 
      date: '2024-05-26', 
      time: '09:00 AM', 
      location: 'Main Sanctuary', 
      type: 'WORSHIP',
      coordinator: 'Pastor John Kamau',
      recurrence: 'WEEKLY',
      attendance: ['1', '2'] 
    },
    { 
      ...
      description: 'Diving deep into the scriptures.', 
      date: '2024-05-29', 
      time: '05:30 PM', 
    ...
    { 
      id: 'ev3', 
      title: 'Nairobi West Street Outreach', 
      description: 'Reaching out to the community in Nairobi West.', 
      date: '2024-06-01', 
      time: '10:00 AM', 
      location: 'Nairobi West Plaza', 
      type: 'OUTREACH',
      coordinator: 'David Ochieng',
      contactPerson: '0712345678',
      rsvpDeadline: '2024-05-31',
      attendance: [] 
    }
  ]);
  ...
  const renderView = () => {
    ...
    switch (currentView) {
      ...
      case 'MY_PORTAL':
        return <MemberPortal member={currentMember} transactions={transactions} events={events} onNavigate={setCurrentView} onUpdateProfile={handleUpdateMember} />;
      case 'MY_GIVING':
        return <MyGiving member={currentMember} transactions={transactions} onGive={() => addToast("M-Pesa STK Push initiated...")} />;
      case 'MEMBERS':
        return <Membership 
          members={members} 
